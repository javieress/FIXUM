...
router.get('/user-edit-password/:id',auth.verifyToken,auth.isAdmin,async (req,res,next)=>{
    res.render('./register/password-edit.ejs',{title: ' | Editar Contraseña de Usuario', user: await userController.get(req,res), message: '', navBar: await auth.navigationBar(req)})
})
